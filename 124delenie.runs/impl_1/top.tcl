...
set rc [catch {
  ...
  set_property ip_output_repo M:/2010/IVBO-01-20/Dvurechensky/VGA_LASTVERS2/VGA_LASTVERS2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet M:/2010/IVBO-01-20/Dvurechensky/VGA_LASTVERS2/VGA_LASTVERS2.runs/synth_1/top.dcp
